...
class Bolt6_GetupCfg(LeggedRobotCfg):
    ...
    class rewards( LeggedRobotCfg.rewards ):
        class scales( LeggedRobotCfg.rewards.scales ):
            termination = -100.
            # traking
            tracking_lin_vel = 0. #10
            tracking_ang_vel = 0. #10.
            ...
            stand_still_pb = 0.#1.0
            no_fly_pb = 0.#5.0
            feet_air_time_pb = 0.#1.
        ...
        standing_target = 0.43 # 0.43 for default position of bolt6
        base_lin_vel_dont_move = 0.
...
class Bolt6_GetupCfgPPO(LeggedRobotCfgPPO):
    seed = -1
